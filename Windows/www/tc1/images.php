...
if (isset($_POST['write']) AND $read == "read"){
    ...
    if($_POST['fpgaVersionActive'] == 1){
        snmp2_set($device_IP, "private", $swRow1['fpgaVersionActive'], "i", "1");
        snmp2_set($device_IP, "private", $swRow2['fpgaVersionActive'], "i", "0");
    } else {
        snmp2_set($device_IP, "private", $swRow1['fpgaVersionActive'], "i", "0");
        snmp2_set($device_IP, "private", $swRow2['fpgaVersionActive'], "i", "1");
    }
