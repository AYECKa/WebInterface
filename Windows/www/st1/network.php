                ...
                <td>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Port State</td>
                            <td>
                                <select name="managementPortState" disabled>
                                    <option value="0" <?php if($managementPortState == "0"){echo "selected";}?>>Off</option>
                                    <option value="1" <?php if($managementPortState == "1"){echo "selected";}?>>On</option>
                                </select>
                            </td>
                        </tr><tr>
                            <td>Isolate Network</td>
                            <td><select name="isolateNetworks" disabled>
                                    <option value="1" <?php if($isolateNetworks == 1){echo "selected";}?>>Isolated</option>
                                    <option value="0" <?php if($isolateNetworks == 0){echo "selected";}?>>Connected</option>
                                </select></td>
                        </tr>
