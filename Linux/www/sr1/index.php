            ...
            <tr><td>
                    ...
                    <table border="0">
                        <tr>
                            ...
                            <td>Bad Packets</td>
                            <td><input type="text" value="<?php echo $badPacketCount1; ?>" name="badPacketCount1" readonly></td>
                        </tr><tr>
                            <td>MODCOD</td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>Bad Packets</td>
                            <td><input type="text" value="<?php echo $badPacketCount2; ?>" name="badPacketCount2" readonly></td>
                        </tr><tr>
                            <td>MODCOD</td>
